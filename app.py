...
st.write("*Este modelo ha sido entrenado con imágenes generadas por las herramientas de IA generativa: FaceSwap, SFHQ (StyleGAN Face HQ), Stable Diffusion, This PersonDoesNotExist. Si se adjuntan fotos de otros modelos, el resultado puede ser erróneo.*")
